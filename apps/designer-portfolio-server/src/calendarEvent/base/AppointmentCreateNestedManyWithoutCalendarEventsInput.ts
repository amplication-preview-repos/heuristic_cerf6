...
@InputType()
class AppointmentCreateNestedManyWithoutCalendarEventsInput {
...
export { AppointmentCreateNestedManyWithoutCalendarEventsInput as AppointmentCreateNestedManyWithoutCalendarEventsInput };
