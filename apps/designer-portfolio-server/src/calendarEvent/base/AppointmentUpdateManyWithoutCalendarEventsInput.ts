...
@InputType()
class AppointmentUpdateManyWithoutCalendarEventsInput {
...
export { AppointmentUpdateManyWithoutCalendarEventsInput as AppointmentUpdateManyWithoutCalendarEventsInput };
