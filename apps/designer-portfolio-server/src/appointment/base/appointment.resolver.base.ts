...
export class AppointmentResolverBase {
  ...
  async createAppointment(
    ...
    return await this.service.createAppointment({
      ...
      data: {
        ...
        calendarEvent: args.data.calendarEvent
          ? {
              connect: args.data.calendarEvent,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => CalendarEvent, {
    nullable: true,
    name: "calendarEvent",
  })
  @nestAccessControl.UseRoles({
  ...
  async getCalendarEvent(
    ...
    const result = await this.service.getCalendarEvent(parent.id);
